...
public:
	...
	void draw_text_v52(int X, int Y, vgui::HFont, bool center_width, bool center_height, Color Color, std::string Input);
	...
	Vector2D GetTextSize(vgui::HFont, std::string Input);
