...
void render::setup() {
	...
	fonts[USIATEXT] = create_font("Verdana", 12, FW_BOLD, FONTFLAG_DROPSHADOW);
	fonts[USIABOLD] = create_font("Verdana", 12, FW_BOLD, FONTFLAG_OUTLINE);
	fonts[ESPFLAG] = create_font("Verdana", 12, 0, FONTFLAG_NONE);
	fonts[TAHOMA12] = create_font("Tahoma", 12, FW_NORMAL, FONTFLAG_OUTLINE);
	fonts[MENUNAME] = create_font("Verdana", 15, FW_THIN, FONTFLAG_OUTLINE);
	fonts[VERDANA12] = create_font("Verdana", 12, FW_NORMAL, FONTFLAG_NONE);
	fonts[VERDANA12OUT] = create_font("Verdana", 12, FW_NORMAL, FONTFLAG_OUTLINE);
	fonts[VERDANA12BOLD] = create_font("Verdana", 12, FW_BOLD, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	fonts[VERDANA12BOLDOUT] = create_font("Verdana", 12, FW_BOLD, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	fonts[ESPNAME] = create_font("Verdana", 12, FW_THIN, FONTFLAG_OUTLINE);
	fonts[ESPHEALTH] = create_font("Verdana", 12, FW_THIN, FONTFLAG_OUTLINE);
	fonts[WEAPONICONS] = create_font("undefeated", 10, FW_MEDIUM, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	fonts[SUBTABWEAPONS] = create_font("undefeated", 12, FW_MEDIUM, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	fonts[INDICATORFONT] = create_font("Verdana", 32, FW_SEMIBOLD, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	fonts[INDICATORFONTSMALL] = create_font("Verdana", 22, FW_SEMIBOLD, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	fonts[TABFONT] = create_font("subliminal", 12, FW_NORMAL, FONTFLAG_ANTIALIAS);
	fonts[USIAFONT] = create_font("skeet_tab_font_by_lemon", 12, FW_BOLD, FONTFLAG_ANTIALIAS);
	fonts[TABICONS] = create_font("skeet_tab_font_by_lemon", 50, FW_BOLD, FONTFLAG_ANTIALIAS);
}
...
void render::textured_polygon(int n, std::vector<Vertex_t> vertice, Color color)
{
