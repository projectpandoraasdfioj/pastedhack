...
void eventlogs::paint_traverse() {
	...
	auto name_size = render::get().text_width(name_font, "[pasted] ");
	...
	for (unsigned int i = 0; i < logs.size(); i++) {
		...
		render::get().text(font, 5, last_y + 20 + log.y, front_color, HFONT_CENTERED_NONE, "[pasted] ");
