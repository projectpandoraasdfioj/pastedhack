...
struct IMGUI_API ImGuiWindow
{
	...
	bool					StartedDragging = false;			// Hacky fix. Need to check if we've already clicked the window, used to work on previous versions but idk what happened to this feature.
