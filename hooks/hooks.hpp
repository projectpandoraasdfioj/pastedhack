...
static T* Find_Hud_Element(const char* name)
{
	...
	static auto find_hud_element = reinterpret_cast<DWORD(__thiscall*)(void*, const char*)>(util::pattern_scan("client_panorama.dll", "55 8B EC 53 8B 5D 08 56 57 8B F9 33 F6 39"));
