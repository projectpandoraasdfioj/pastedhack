...
template< typename Function > Function call_vfuncxd(PVOID Base, DWORD Index)
{
...
public:
	...
	inline const char* GetModelNamevoid(const void* Model) {
		return call_vfuncxd<const char*(__thiscall *)(void*, const void*)>(this, 3)(this, Model);
	}
	inline void* GetModelvoid(int Index) {
		return call_vfuncxd<void*(__thiscall *)(void*, int)>(this, 1)(this, Index);
	};
};
