...
void setup_main_menu() {
	...
	auto rage_tab = new C_Tab(&menu::get(), 0, "b", "A", {
		...
		auto rage = new C_GroupBox(GROUP_LEFT, 8, ""); {
			...
			auto fov = new C_SliderInt("field of view", &g_cfg.ragebot.field_of_view, 0, 360, "d");
		}
	...
	auto antiaim_tab = new C_Tab(&menu::get(), 2, "i", "F", {
		...
		for (int i = 0; i < 3; i++) {
			...
			auto antiaim = new C_GroupBox(GROUP_LEFT, 8, ""); {
				...
				auto yaw_offset = new C_SliderInt("", &g_cfg.antiaim.yaw_offset[i], -180, 180, "d");
				...
				auto fakeyaw_offset = new C_SliderInt("", &g_cfg.antiaim.fake_yaw_offset[i], -180, 180, "d");

				auto lby_breaker = new C_CheckBox("lby breaker", &g_cfg.antiaim.lby_breaker);
				auto lby_delta = new C_SliderInt("", &g_cfg.antiaim.lby_delta, 0, 180, "d");
			...
			for (int i = 0; i < 3; i++) {
				...
				auto fakelag_mode = new C_Dropdown("", &g_cfg.antiaim.fakelag_mode, { "factor" });
	...
	auto esp_tab = new C_Tab(&menu::get(), 1, "d", "C", {
		...
		auto player_2 = new C_GroupBox(GROUP_RIGHT, 8, ""); {
			...
			auto local_chams_alpha = new C_SliderInt("", &g_cfg.esp.local_chams_alpha, 0, 100, "%");
		...
		auto esp = new C_GroupBox(GROUP_LEFT, 8, ""); {
			...
			auto fov = new C_SliderInt("override fov", &g_cfg.esp.fov, 0, 89, "d");
	...
	auto misc_tab = new C_Tab(&menu::get(), 3, "c", "D"); {
		...
		auto miscellaneous = new C_GroupBox(GROUP_LEFT, 8, ""); {
			...
			auto thirdperson_distance = new C_SliderInt("thirdperson distance", &g_cfg.misc.thirdperson_distance, 100, 150, "d");
	...
	auto skins_tab = new C_Tab(&menu::get(), 4, "s", "E"); {
		auto skins1 = new C_GroupBox(GROUP_LEFT, 8, ""); {



		}
		auto skins2 = new C_GroupBox(GROUP_RIGHT, 9, ""); {
